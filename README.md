...
--env=LD_LIBRARY_PATH=EXT_DEST/texlive/lib:EXT_DEST/texlive/lib/perl5/5.40.1/aarch64-linux/CORE:EXT_DEST/texlive/lib/perl5/5.40.1/x86_64-linux/CORE
--env=PERL5LIB=EXT_DEST/texlive/lib/perl5/5.40.1:EXT_DEST/texlive/lib/perl5/site_perl/5.40.1
```
